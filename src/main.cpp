...
#if defined(NDEBUG)
# error "GCR cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "GCR Signed Message:\n";
...
bool CBlock::AcceptBlock()
{
    ...
    if (IsProtocolV2(nHeight) && nVersion < 2)
        return DoS(100, error("AcceptBlock() : reject too old nVersion = %d", nVersion));
    else if (!IsProtocolV2(nHeight) && nVersion > 1)
