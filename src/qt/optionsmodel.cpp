...
void OptionsModel::Init()
{
    ...
    fUseGreenTheme = settings.value("fUseGreenTheme", true).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case useRedTheme:
            return QVariant(fUseGreenTheme);
        default:
            return QVariant();
        }
    }
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case MinimizeCoinAge:
           ...
           break;
        case useRedTheme:
            fUseGreenTheme = value.toBool();
            settings.setValue("fUseGreenTheme", fUseGreenTheme);
            break;
        default:
            break;
        }
